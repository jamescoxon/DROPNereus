...
while True:
	...
	if(gps_data['position']['latitude'] != 0.0):
		...
		#Print data
		telem_string = "%d,%f,%f,%.2f,%d,%d,%d,%d" % (user_time, gps_data['position']['latitude'], gps_data['position']['longitude'], gps_data['course']['speed'], gps_data['course']['heading'], gps_data['satellites']['used_satellites'], signal, battery)
		...
		print "No GPS Position yet, retry:", loop_number, " Sats :", gps_data['satellites']['used_satellites']
